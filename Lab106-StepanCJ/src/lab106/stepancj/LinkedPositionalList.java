 ...
 * Fragments 7.9-7.12, 7.14 Cross-Referenced with the IteratorExample
 * LinkedPositionalList class by
 *
 * @author Joe Latimer
 *
 * Transcribed by
...
public class LinkedPositionalList<E> implements PositionalList<E> {
    ...
    private static class Node<E> implements Position<E> {
        ...
        public E getElement() throws IllegalStateException {
            ...
            {
                throw new IllegalStateException("Positon no longer valid");
            }
            return element;
        }
    ...
    //Returns the number of elemtns in the linked list
    public int size() {
        return size;
    }
    ...
    //Returns an interator of the elemtns stored in the list
